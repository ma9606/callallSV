...
for($i=0;$i<=$#tmpDIR;$i++){
    ...
    close(FILE_chr1);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr1.chim | awk -f ./.judge_cluster.awk - >  ${dir}/chr1.BP_list_0;");
    close(FILE_chr2);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr2.chim | awk -f ./.judge_cluster.awk - >  ${dir}/chr2.BP_list_0;");
    close(FILE_chr3);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr3.chim | awk -f ./.judge_cluster.awk - >  ${dir}/chr3.BP_list_0;");
    close(FILE_chr4);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr4.chim | awk -f ./.judge_cluster.awk - >  ${dir}/chr4.BP_list_0;");
    close(FILE_chr5);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr5.chim | awk -f ./.judge_cluster.awk - >  ${dir}/chr5.BP_list_0;");
    close(FILE_chr6);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr6.chim | awk -f ./.judge_cluster.awk - >  ${dir}/chr6.BP_list_0;");
    close(FILE_chr7);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr7.chim | awk -f ./.judge_cluster.awk - >  ${dir}/chr7.BP_list_0;");
    close(FILE_chr8);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr8.chim | awk -f ./.judge_cluster.awk - >  ${dir}/chr8.BP_list_0;");
    close(FILE_chr9);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr9.chim | awk -f ./.judge_cluster.awk - >  ${dir}/chr9.BP_list_0;");
    close(FILE_chr10);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr10.chim | awk -f ./.judge_cluster.awk - > ${dir}/chr10.BP_list_0;");
    close(FILE_chr11);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr11.chim | awk -f ./.judge_cluster.awk - > ${dir}/chr11.BP_list_0;");
    close(FILE_chr12);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr12.chim | awk -f ./.judge_cluster.awk - > ${dir}/chr12.BP_list_0;");
    close(FILE_chr13);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr13.chim | awk -f ./.judge_cluster.awk - > ${dir}/chr13.BP_list_0;");
    close(FILE_chr14);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr14.chim | awk -f ./.judge_cluster.awk - > ${dir}/chr14.BP_list_0;");
    close(FILE_chr15);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr15.chim | awk -f ./.judge_cluster.awk - > ${dir}/chr15.BP_list_0;");
    close(FILE_chr16);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr16.chim | awk -f ./.judge_cluster.awk - > ${dir}/chr16.BP_list_0;");
    close(FILE_chr17);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr17.chim | awk -f ./.judge_cluster.awk - > ${dir}/chr17.BP_list_0;");
    close(FILE_chr18);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr18.chim | awk -f ./.judge_cluster.awk - > ${dir}/chr18.BP_list_0;");
    close(FILE_chr19);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr19.chim | awk -f ./.judge_cluster.awk - > ${dir}/chr19.BP_list_0;");
    close(FILE_chr20);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr20.chim | awk -f ./.judge_cluster.awk - > ${dir}/chr20.BP_list_0;");
    close(FILE_chr21);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr21.chim | awk -f ./.judge_cluster.awk - > ${dir}/chr21.BP_list_0;");
    close(FILE_chr22);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chr22.chim | awk -f ./.judge_cluster.awk - > ${dir}/chr22.BP_list_0;");
    close(FILE_chrX);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chrX.chim | awk -f ./.judge_cluster.awk - >  ${dir}/chrX.BP_list_0;");
    close(FILE_chrY);	system("sort -k4,4n -k6,6n -k13,13 ${dir}/.chrY.chim | awk -f ./.judge_cluster.awk - >  ${dir}/chrY.BP_list_0;");
}
close(FILE);
